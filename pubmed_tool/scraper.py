...
def display_message(message, type = None):
    log_it = True
    if 'logger' in globals() and 'logging' in globals():
        log_it = True
    else:
        logger = None
        log_it = False
    if log_it:
        if str(type(logger)) == "<class 'logging.Logger'>":
            log_it = True
        else:
            log_it = False
            type = None
...
def pubmed_search_ids(
    ...
    if not keyword:
        ...
        display_message(message, type = 'warning')
        message = None
    ...
    # ------------------------------------------------------------------------
        ...
        display_message(message, type = 'info')
    ...
    # ------------------------------------------------------------------------
            message = ' '.join([
                    ...
                    f'{e}'])
            display_message(message, type = 'error')
